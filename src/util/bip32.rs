...
impl ExtendedPrivKey {
    ...
    pub fn from_path<C: secp256k1::Signing>(secp: &Secp256k1<C>, master: &ExtendedPrivKey, path: &[ChildNumber])
...
impl ExtendedPubKey {
    ...
    pub fn ckd_pub<C: secp256k1::Verification>(&self, secp: &Secp256k1<C>, i: ChildNumber) -> Result<ExtendedPubKey, Error> {
